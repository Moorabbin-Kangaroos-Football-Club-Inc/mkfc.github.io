...
The existing hatnote points readers seeking the modern Moorabbin Kangaroos to the SFNL article, which contains no club-specific content. The replacement points to a dedicated *Moorabbin Kangaroos Football Club* article (proposed in Edit 3) covering the post-1965 successor club.

## Dependency

Should only be applied **after** the new *Moorabbin Kangaroos Football Club* article is created — otherwise the hatnote will redlink.
