...
Submit via [Articles for Creation](https://en.wikipedia.org/wiki/Wikipedia:Articles_for_creation) so a neutral reviewer can apply Wikipedia's notability and sourcing checks before the article goes live in mainspace. If editing on behalf of the club, declare conflict of interest on the submitter's user page.
